...
import { CurationCommand } from './src/curate/curation-command.js';
import { RecordationCommand } from './src/record/recordation-command.js';
...
const recordation = new RecordationCommand()
commands = recordation.add(commands);

const configuration = new ConfigurationCommand();
commands = configuration.add(commands);

const curation = new CurationCommand();
commands = curation.add(commands);
