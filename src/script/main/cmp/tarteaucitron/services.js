...
// activecampaignvgo
export const activecampaignvgo = {
...
// wysistathightrack
export const wysistathightrack = {
...
// aduptech conversion
export const aduptech_conversion = {
...
export const aduptech_retargeting = {
...
export const dailymotion = {
    ...
    js: function () {
        ...
        tarteaucitron.fallback(['dailymotion_player'], function (x) {
            ...
            video_frame =
                '<iframe class="fr-responsive-vid" title="' +
                frame_title +
...
// dating affiliation
export const datingaffiliation = {
...
export const datingaffiliationpopup = {
...
export const adsensesearchform = {
...
export const adsensesearchresult = {
...
export const googleadwordsconversion = {
...
export const googleadwordsremarketing = {
...
export const multiplegoogletagmanager = {
...
export const instagram = {
    ...
    js: function () {
        ...
        tarteaucitron.fallback(['instagram_post'], function (x) {
            const permalink = tarteaucitron.getElemAttr(
                x,
                'data-instgrm-permalink'
            );
            const captioned =
                tarteaucitron.getElemAttr(x, 'data-instgrm-captioned') ===
                'true'
                    ? 'data-instgrm-captioned'
                    : '';
            const igVersion =
                tarteaucitron.getElemAttr(x, 'data-instgrm-version') || '14';

            if (!permalink) {
                return '';
            }

            return `<blockquote class="instagram-media" ${captioned} data-instgrm-permalink="${permalink}" data-instgrm-version="${igVersion}"></blockquote>`;
        });
    },
    fallback: function () {
        'use strict';
...
// twitterwidgetsapi
export const twitterwidgetsapi = {
...
export const microsoftcampaignanalytics = {
...
// AT Internet
export const atinternethightrack = {
...
export const facebookcustomerchat = {
...
export const batchnotification = {
    key: 'batchnotification',
    type: 'other',
    name: 'Batch',
    uri: 'https://batch.com/fr/blog/posts/data-privacy-differentiators',
    needConsent: true,
    cookies: [],
    js: function () {
        'use strict';
        ...
        window.batchSDK('setup', {
            ...
            dev: process.env.BATCH_DEV,
            vapidPublicKey: process.env.BATCH_PUBLIC_KEY,
            ui: {
                native: { autoShow: false },
            },
            safari: process.env.BATCH_SAFARI_HOST,
        });
    },
};
